...
public class MintDBHelper {
    ...
    public static final String KEY_NOTES= "notes";	//��ע
    public static final String KEY_STATUS= "status";	//status(0 income/ )
    
    /*
     * consumption
     */
    public static final String KEY_CONSUMPTION_TITLE = "consumption_title";	//�����Ŀ���
    public static final String KEY_PRICE = "price";	//��ѽ��
    public static final String KEY_CONSUMPTION_TYPE = "consumption_type";	//�������
    public static final String KEY_QUANTITY= "quantity";	//�˴ι�������
    
    
    /*
     * rank
     */
    public static final String KEY_COUNTS = "counts";	//�����¼����Ʒ�������
    public static final String KEY_LASTPRICE = "last_price";	//�ϴι�����
    
    /*
     * debt
     */
    public static final String KEY_DEBTOR = "debtor";	//ծ���� 
    public static final String KEY_CLEAR = "clear";	//�Ƿ�����
    
    /*
     * budget
     */
    public static final String KEY_BUDGET = "budget";	//Ԥ����
    public static final String KEY_OUT = "out";	//ʵ��֧��
    public static final String KEY_CYCLE = "cycle";	//Ԥ������
