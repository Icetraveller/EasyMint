...
public class ActivityHelper {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        mActivity.getMenuInflater().inflate(R.menu.budget_menu_items, menu);
        return false;
    }
...
//        TextView actionTextView = new TextView(mActivity, null, R.style.ActionBarCompatText);
//        actionTextView.setLayoutParams(new ViewGroup.LayoutParams(
//              (int) mActivity.getResources().getDimension(R.dimen.actionbar_compat_height),
//              ViewGroup.LayoutParams.FILL_PARENT));
